...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [self.window setRootViewController:[[UINavigationController alloc] initWithRootViewController:[[CWColorPickerViewController alloc] init]]];
    [self.window makeKeyAndVisible];
    return YES;
}

- (void) show :(NSString *)a :(NSString *)b :(NSString *)c  {
